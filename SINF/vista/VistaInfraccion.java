...
public class VistaInfraccion extends JInternalFrame {
	...
	public JTextField txtMarcaSubmarca;
	...
	public JTextField txtArticulosViolados;
	...
	public VistaInfraccion() {
		...
		lblNoLicensiaDel = new JLabel("N\u00B0 licencia del conductor:");
		...
		getContentPane().add(lblElServicio, "flowx,cell 0 14");
		...
		getContentPane().add(txtMotivo, "cell 0 16,grow");
		...
		getContentPane().add(lblResponsableDelPrograma, "flowx,cell 0 17");
		...
		getContentPane().add(btnInsertar, "flowx,cell 0 19,growx,aligny baseline");
		...
		txtMarcaSubmarca = new JTextField();
		txtMarcaSubmarca.setBorder(null);
		txtMarcaSubmarca.setForeground(new Color(58, 63, 64));
		txtMarcaSubmarca.setToolTipText("");
		txtMarcaSubmarca.setFont(new Font("Arial", Font.BOLD, 14));
		txtMarcaSubmarca.setColumns(10);
		txtMarcaSubmarca.setBackground(new Color(187,202,204));
		getContentPane().add(txtMarcaSubmarca, "cell 0 5,growx");
		...
		getContentPane().add(lblMotivocircunstanciaDe, "flowx,cell 0 15");
		...
		getContentPane().add(txtNpolicia, "cell 0 17,growx");
		...
		getContentPane().add(lblArticulosViolados, "flowx,cell 0 12");

		lblRetencionDe = new JLabel("Retenci\u00F3n de:");
		lblRetencionDe.setFont(new Font("Arial", Font.BOLD, 14));
		getContentPane().add(lblRetencionDe, "flowx,cell 0 13");
		...
		getContentPane().add(txtRetencion, "cell 0 13,growx");
		...
		getContentPane().add(txtMarcaModelo, "cell 0 14,growx");
		...
		getContentPane().add(btnLimpiar, "cell 0 19,growx,aligny baseline");
		...
		txtArticulosViolados = new JTextField();
		...
		txtArticulosViolados.setColumns(10);
		txtArticulosViolados.setBackground(new Color(187, 202, 204));
		getContentPane().add(txtArticulosViolados, "cell 0 12,growx");
